...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=INT-KhanhDV\\MSSQLSERVER08;Initial Catalog=DoAn3;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryName, "UQ__Categori__8517B2E08D3F7D12").IsUnique();
        ...
        modelBuilder.Entity<Color>(entity =>
        {
            ...
            entity.HasIndex(e => e.ColorName, "UQ__Color__C71A5A7B1F57FCE7").IsUnique();

            entity.Property(e => e.ColorCode)
                .HasMaxLength(10)
                .IsUnicode(false)
                .HasColumnName("colorCode");
            entity.Property(e => e.ColorName).HasMaxLength(300);
        });
        ...
        modelBuilder.Entity<Department>(entity =>
        {
            ...
            entity.HasIndex(e => e.DepartmentName, "UQ__Departme__D949CC34B974C72C").IsUnique();
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasIndex(e => e.StoreId, "index_store_id");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ImagesSa__3214EC07F0FAD52E");
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.PositionName, "UQ__Position__E46AEF42820655B0").IsUnique();
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasIndex(e => e.ProductName, "UQ__Products__DD5A978ACB68A0BC").IsUnique();

            entity.Property(e => e.Brand).HasMaxLength(200);
            entity.Property(e => e.MainImg).IsUnicode(false);
        ...
        {
            entity.HasKey(e => e.RefreshTokenCustomerId).HasName("PK__RefreshT__EB55C112CFE368FC");
        ...
        modelBuilder.Entity<Role>(entity =>
        {
            ...
            entity.HasIndex(e => e.RolesName, "UQ__Roles__CD1DC953E289D3CD").IsUnique();
        ...
        modelBuilder.Entity<Store>(entity =>
        {
            ...
            entity.HasIndex(e => e.StoreName, "UQ__Stores__520DB652F5A210CF").IsUnique();
        ...
        modelBuilder.Entity<TypeAccount>(entity =>
        {
            ...
            entity.HasIndex(e => e.TypeAccName, "UQ__TypeAcco__DBF27857EC25C511").IsUnique();
        ...
        modelBuilder.Entity<Warehouse>(entity =>
        {
            ...
            entity.HasIndex(e => e.WarehouseName, "UQ__Warehous__180C89D945B0D13E").IsUnique();
